                ...
                (res) => {
                    ...
                    setFormData((prevState) => ({
                        ...prevState,
                            ...
                            senderPhone: res.data.sender.phone,
                            senderEmail: res.data.sender.email,
                            senderAddress: res.data.sender.address,
                            recipientName: res.data.recipient.name,
                            recipientPhone: res.data.recipient.phone,
                            recipientEmail: res.data.recipient.email,
                            recipientAddress: res.data.recipient.address,
                    }));
